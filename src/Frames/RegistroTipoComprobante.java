 ...
 * @author Paul
 */
public class RegistroTipoComprobante extends javax.swing.JInternalFrame {

    /**
     * Creates new form RegistroTipoComprobante
     */
    public RegistroTipoComprobante() {
        initComponents();
        Cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de Tipo de Comprobante");
    ...
    private void Cargar(){
        ...
        tblPrincipal.setModel(MetodoTipos.MostrarTodosTipoComprobante()); 
    }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(!flag){
            MetodoTipos.ActualizarTipoComprobante(txtId.getText(),txtDescripcion.getText());
            Cargar();
            limpiar();
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        boolean flag = txtId.getText().equals("") || txtDescripcion.getText().equals("");
        if(!flag){
            MetodoTipos.InsertarTipoComprobante(txtId.getText(),txtDescripcion.getText());
            Cargar();
            limpiar();
        }
