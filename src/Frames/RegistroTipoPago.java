 ...
 * @author Paul
 */
public class RegistroTipoPago extends javax.swing.JInternalFrame {

    /**
     * Creates new form RegistroTipoPago
     */
    public RegistroTipoPago() {
        initComponents();
        Cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de Tipo de Pago");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de Tipo de Comprobante:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 2, 11), new java.awt.Color(33, 97, 140))); // NOI18N
    ...
    private void Cargar(){
        ...
        tblPrincipal.setModel(MetodoTipos.MostrarTodosTipoPago());
        tblPrincipal.getColumnModel().getColumn(0).setPreferredWidth(10);
        tblPrincipal.getColumnModel().getColumn(1).setPreferredWidth(150);
    }
    ...
    private void tblPrincipalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPrincipalMouseClicked
        ...
        txtDescripcion.setText(tblPrincipal.getValueAt(row, 1).toString());
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(!flag){
            MetodoTipos.InsertarTipoPago(txtId.getText(),txtDescripcion.getText());
            Cargar();
            limpiar();
        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        boolean flag = txtId.getText().equals("") || txtDescripcion.getText().equals("");
        if(!flag){
            MetodoTipos.ActualizarTipoPago(txtId.getText(),txtDescripcion.getText());
            Cargar();
            limpiar();
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(null, "Estas Seguro de Eliminar esta TIPO DE PAGO. Recuerda que al eliminar un TIPO DE PAGO, ELIMINAS todos los DOCUMENTOS relacionados a esta","ADVERTENCIA", JOptionPane.YES_NO_OPTION);
        if(respuesta == JOptionPane.YES_OPTION){
            boolean flag = txtId.getText().equals("");
            if(!flag){
                MetodoTipos.EliminarTipoPago(txtId.getText());
                Cargar();
                limpiar();
            }
        }
