 ...
 * @author Paul
 */
public class RegistroMarca extends javax.swing.JInternalFrame {
    ...
    private void Cargar(){
        ...
        tblPrincipal.setModel(MetodoMarcas.BuscarMarcas("")); 
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Registro de Marca de Productos");
        ...
        jLabel1.setText("Id:");
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, -1, -1));

        txtId.setEditable(false);
        txtId.setBackground(new java.awt.Color(240, 240, 240));
        jPanel3.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 200, 25));

        txtDescripcion.setEditable(false);
        txtDescripcion.setBackground(new java.awt.Color(240, 240, 240));
        jPanel3.add(txtDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 80, 200, 25));

        lblDescripcion.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblDescripcion.setForeground(new java.awt.Color(0, 0, 0));
        lblDescripcion.setText("Descripción:");
        jPanel3.add(lblDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, -1, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        // TODO add your handling code here:
        boolean flag = txtDescripcion.getText().equals("");
        if(!flag){
            MetodoMarcas.RegistraMarca(txtDescripcion.getText().toUpperCase());
        }
        Cargar();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(!flag){
            MetodoMarcas.ModificarMarca(txtId.getText(), txtDescripcion.getText());
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(respuesta == JOptionPane.YES_OPTION){
            ...
            if(!flag){
                MetodoMarcas.EliminarMarca(txtId.getText());
            }
            Cargar();
        }
