 ...
 * @author Paul
 */
public class RegistroTipoCondicion extends javax.swing.JInternalFrame {

    /**
     * Creates new form RegistroTipoComprobante
     */
    public RegistroTipoCondicion() {
        initComponents();
        Cargar();
    }
    private void Cargar(){
        // TODO add your handling code here:
        tblPrincipal.setModel(MetodoTipos.MostrarTodosTiposCondicion()); 
    }
    ...
    private void initComponents() {
        ...
        txtDiasCredito = new jtextfieldround.JTextFieldRound();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de Tipo de Condicion:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 2, 11), new java.awt.Color(33, 97, 140))); // NOI18N
        ...
        lblDescripcion.setText("Dias Credito:");

        txtDiasCredito.setEditable(false);
        txtDiasCredito.setBackground(new java.awt.Color(240, 240, 240));
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDiasCredito, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(30, 30, 30)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblDescripcion)
                    .addComponent(txtDiasCredito, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblDescripcion1)
    ...
    private void tblPrincipalMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPrincipalMouseClicked
        ...
        txtDiasCredito.setText(tblPrincipal.getValueAt(row, 1).toString());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(null, "Estas Seguro de Eliminar esta TIPO DE CONDICION. Recuerda que al eliminar un TIPO DE CONDICION, ELIMINAS todos los DOCUMENTOS relacionados a esta","ADVERTENCIA", JOptionPane.YES_NO_OPTION);
        if(respuesta == JOptionPane.YES_OPTION){
            boolean flag = txtId.getText().equals("");
            if(!flag){
                MetodoTipos.EliminarTipoCondicion(txtId.getText());
                Cargar();
                limpiar();
            }
        }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
        boolean flag = txtId.getText().equals("") || txtDescripcion.getText().equals("");
        if(!flag){
            MetodoTipos.ActualizarTipoCondicion(txtId.getText(),Integer.parseInt(txtDiasCredito.getText()) ,txtDescripcion.getText());
            Cargar();
            limpiar();
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        boolean flag = txtId.getText().equals("") || txtDescripcion.getText().equals("");
        if(!flag){
            MetodoTipos.InsertarTipoCondicion(txtId.getText(), Integer.parseInt(txtDiasCredito.getText()),txtDescripcion.getText());
            Cargar();
            limpiar();  
        }
    ...
    private jtextfieldround.JTextFieldRound txtDiasCredito;
